...
class ExtraController extends AbstractController
{
    ...
    {
        return $this->render('extra/index.html.twig', ['extras' => $extraRepository->findAll()]);
    }
    ...
    {
        return $this->render('extra/show.html.twig', ['extra' => $extra]);
    }
    ...
    public function edit(Request $request, Extra $extra): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('extra_edit', ['id' => $extra->getId()]);
        }
